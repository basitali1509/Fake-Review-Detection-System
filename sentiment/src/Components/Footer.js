  ...
  <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    ...
    <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
      <div class="mx-auto max-w-sm lg:max-w-none">
        ...
        Product Analysis with our Fare-Det. Track
                                real-time usage of product, detect Fake and real reviews, and prioritize Authenicity for a smarter approach to sentiments of the customers.
        </p> 
