  ...
  return (
    <>
      ...
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div class="bg-red-900 text-cyan-50 border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
         
          <FontAwesomeIcon icon={faEnvelope} className="text-red-800 w-12 h-12 mb-3 inline-block"/>
