  ...
  return (
      ...
      >
        ...
        <form  className="w-full md:w-96 flex flex-col gap-6 transition-all duration-400">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <Input
                  ...
                  color="white"                  type={showPassword ? "text" : "password"} // Change type based on visibility
                  value={password}
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <Input
                  placeholder="********"
                  className=" !border-t-blue-gray-200 focus:!border-t-teal-300"
                  color="white"                 type={showConfirmPassword ? "text" : "password"}
          ...
          <Button color="teal" onClick={handleSubmit} type="button" fullWidth disabled={!isFormValid}>
            Sign Up
          </Button>
        </form>
      </Card>
